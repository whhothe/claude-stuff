...
18 PNGs in `visuals/`, 1920×2160 (8:9) — sized for half of a 16:9 screen so they sit beside the speaker in a side-by-side recording. One idea each, big type, minimal text; the script carries the explanation. Cue order: `the-collapse`, `what-it-is-not`, `curiosity`, `three-tests`, `the-runtime`, `series`, `same-month`, `the-ask`, `observer`, `detective`, `detective-2`, `four-changes`, `format-test`, `what-makes-it-abyssal`, `the-document`, `pitch-collapses`, `pitch-lifts`, `pitch-casting`. `visuals/_source.html` regenerates them.
